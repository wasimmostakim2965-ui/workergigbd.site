                ...
                {tasks.map((task) => (
                  <tr key={task.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-5 py-3 font-semibold text-success-600">
                      $ {(((task.jobs?.reward_per_worker ?? 0) + (task.jobs?.screenshot_count ?? 0) * 0.0001)).toFixed(4)}
                    </td>
        ...
        {selected && (
          <div className="space-y-4">
            <div className="rounded-lg bg-gray-50 p-4 space-y-2 text-sm">
              ...
              <div className="flex justify-between"><span className="text-gray-500">Reward:</span><span className="font-bold text-success-600">$ {(((selected.jobs?.reward_per_worker ?? 0) + (selected.jobs?.screenshot_count ?? 0) * 0.0001)).toFixed(4)}</span></div>
